...
local CyanHubQRIQ5F = Instance.new("ScreenGui")
...
CyanHubQRIQ5F.Name = "CyanHubQRIQ5F"
CyanHubQRIQ5F.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
CyanHubQRIQ5F.ResetOnSpawn = false

Frame.Parent = CyanHubQRIQ5F
Frame.Active = true
...
Title_3.Name = "Title"
Title_3.Parent = TPMenu_2
Title_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Title_3.BackgroundTransparency = 1.000
Title_3.BorderColor3 = Color3.fromRGB(0, 0, 0)
Title_3.BorderSizePixel = 0
Title_3.Size = UDim2.new(1, 0, 0.127659589, 0)
...
noclip.Size = UDim2.new(0.949802816, 0, 0.109042563, 0)
...
local function HAAKU_fake_script() -- MSGMenu.MSG_Handler 
...
coroutine.wrap(HAAKU_fake_script)()
local function CDGJYM_fake_script() -- Close.LocalScript 
...
coroutine.wrap(CDGJYM_fake_script)()
local function KEFB_fake_script() -- MSGMenu_2.MSG_Handler 
...
coroutine.wrap(KEFB_fake_script)()
local function BHBVH_fake_script() -- TPMenu.h 
...
coroutine.wrap(BHBVH_fake_script)()
local function DKQGD_fake_script() -- Theme1.h 
...
coroutine.wrap(DKQGD_fake_script)()
local function HHLOM_fake_script() -- Theme2.h 
...
coroutine.wrap(HHLOM_fake_script)()
local function RWNDZ_fake_script() -- animGUI.h 
...
coroutine.wrap(RWNDZ_fake_script)()
local function MKLGXAX_fake_script() -- rtx.h 
...
coroutine.wrap(MKLGXAX_fake_script)()
local function ZABVKE_fake_script() -- fly.h 
...
coroutine.wrap(ZABVKE_fake_script)()
local function FYUQVB_fake_script() -- TextButton.h 
...
coroutine.wrap(FYUQVB_fake_script)()
local function VUJKQWO_fake_script() -- light.h 
...
coroutine.wrap(VUJKQWO_fake_script)()
local function ODWGB_fake_script() -- TPMenu_2.h 
...
coroutine.wrap(ODWGB_fake_script)()
local function ROCQLG_fake_script() -- explode.MSG_Handler 
...
coroutine.wrap(ROCQLG_fake_script)()
local function LZIMV_fake_script() -- TextButton_2.h 
...
coroutine.wrap(LZIMV_fake_script)()
local function QMYY_fake_script() -- infYield.MSG_Handler 
...
coroutine.wrap(QMYY_fake_script)()
local function JWHNUZ_fake_script() -- noclip.MSG_Handler 
...
coroutine.wrap(JWHNUZ_fake_script)()
local function IJQQ_fake_script() -- explode_2.h 
...
coroutine.wrap(IJQQ_fake_script)()
local function JAYKU_fake_script() -- CyanHubQRIQ5F.LocalScript 
	local script = Instance.new('LocalScript', CyanHubQRIQ5F)
...
coroutine.wrap(JAYKU_fake_script)()
local function MLQGU_fake_script() -- Toggle.LocalScript 
...
coroutine.wrap(MLQGU_fake_script)()
